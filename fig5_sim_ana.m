...
%         N=1;% 每个数据包含N bits
        ...
        R = 0.1;
        eps = 2^R-1;
        K=Karr(cir);%要注意K的变换，要引起用户选择范围的概率
...
%         q = 1/K * ones(1, K);%qk
        ...
        elapsedTime_sim_NRT(cir,cir1) = toc;
        ...
        elapsedTime_sim_RT(cir,cir1) = toc;
        ...
        elapsedTime_ana_NRT(cir,cir1) = toc;
...
%         分析
        ...
        analysis_AoI=[analysis_AoI poi_gs_m];
         elapsedTime_ana_RT(cir,cir1) = toc;
        ps=0;
    end
end

figure(1);
plot(Marr,  analysis_AoI(1:5), 'md-', 'LineWidth', 1.5, 'MarkerSize', 8);%NOMART2
hold on;
plot(Marr,  analysis_AoI(6:10), 'g<-', 'LineWidth', 1.5, 'MarkerSize', 8);%NOMART2
hold on;
 plot(Marr,  analysis_AoI(11:15), 'bo-', 'LineWidth', 1.5, 'MarkerSize', 8);%NOMART6
 hold on;
% %sim
plot(Marr,  simulation_AoI(1:5), 'k--', 'LineWidth', 1.5, 'MarkerSize', 8);%NOMART0.3
hold on;
plot(Marr,  simulation_AoI(6:10), 'k--', 'LineWidth', 1.5, 'MarkerSize', 8);%NOMART0.7
hold on;
plot(Marr,  simulation_AoI(11:15), 'k--', 'LineWidth', 1.5, 'MarkerSize', 8);%NOMART0.7
h=legend( '$K=1$,analysis',...
    '$K=2$,analysis',...
    '$K=6$,analysis');
...
figure(2)
plot(Marr,  analysis_AoI321(1:5), 'md-', 'LineWidth', 1.5, 'MarkerSize', 8);%NOMANRT0.3
hold on;
plot(Marr,  analysis_AoI321(6:10), 'g<-', 'LineWidth', 1.5, 'MarkerSize', 8);%NOMART0.7
hold on;
plot(Marr,  analysis_AoI321(11:15), 'bo-', 'LineWidth', 1.5, 'MarkerSize', 8);%NOMART0.7
hold on;
plot(Marr,  simulation_AoI321(1:5), 'k--', 'LineWidth', 1.5, 'MarkerSize', 8);%NOMANRT0.3
hold on;
plot(Marr,  simulation_AoI321(6:10), 'k--', 'LineWidth', 1.5, 'MarkerSize', 8);%NOMART0.7
hold on;
plot(Marr,  simulation_AoI321(11:15), 'k--', 'LineWidth', 1.5, 'MarkerSize', 8);%NOMART0.7
